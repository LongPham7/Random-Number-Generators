...
public class JavaRNG
{
    ...
    public double[] output()
    {
    	...
    	/*
    	 * This loop inserts a random number with a range from 0.0 to 1.0
     ...
     * @param   n:       array that stores decimal elements produced by a pseudo RNG
    ...
    public double ratio(double[] n)
    {
    	...
    	/*
    	 * This loop traverses the array, counting points whose distance is less
